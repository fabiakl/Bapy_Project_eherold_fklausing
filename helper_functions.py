...
def file_name(current_movie):
    ...
    Returns:
    str: the correct file name of the movie-script
    ...
    for genre in genres:
        ...
        # all file names have the same ending
    ...
    return(None)
    print("Sorry, this movie doesn't seem to be in this database")
...
def same_name(name_script, name_table):
    ...
    r = re.search('.*{}.*'.format(stripped_name), name_table.upper())
    if r:
        return True
    else:
        return False 
